        ...
        initDashboardDaterange: function () {
            ...
            $('#dashboard-report-range').daterangepicker({
                    ...
                    ranges: {
                        ...
                        //'最近15天': [moment().subtract('days', 15), moment().subtract('days', 1)],
                        '上周': [moment().weekday(-6).format('YYYY-MM-DD'), moment().weekday(0).format('YYYY-MM-DD')],
            ...
            //alert(moment().subtract('days', 2).format('YYYY-MM-DD'));
            //$('#dashboard-report-range span').html(moment().subtract('days', 15).format('YYYY-MM-DD') + ' ～ ' + moment().subtract('days', 1).format('YYYY-MM-DD'));

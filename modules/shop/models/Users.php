...
class Users extends ActiveRecord implements IdentityInterface{
    ...
    public function rules()
    {
        return [
            ...
            [ ['user_name', 'password', 'captcha'],'required', 'on' => self::SCENARIO_CREATE],
            [ ['captcha'],'captcha', 'on' => self::SCENARIO_CREATE],
    ...
    public function scenarios()
    {
        return [
            ...
            self::SCENARIO_CREATE => ['user_name', 'password', 'captcha'],
        ];
    }
...
//        return md5(md5($password).$ec_salt);
    ...
    public function login($params)
    {
        ...
        if ($this->load($params) && $this->validate()) {
            if (($user = $this->findByuser_name($this->user_name)) !== null) {
                ...
                $this->addError('user_name', \Yii::t('users','login_failure'));
            }
        }
    ...
    public function afterLogin($event)
    {
        ...
        \Yii::$app->shop_user->login($identity);
    ...
    public function logout()
    {
        ...
        return \Yii::$app->shop_user->logout();
    ...
    public function  captcha()
    {
        ...
        $captchValidator->captchaAction = 'shop/public/captcha';

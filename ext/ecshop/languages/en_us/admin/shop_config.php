...
$_LANG['cfg_name']['email_content'] = 'How are you! Tupload_size_limithis is the test.html mail of an examination mail server setting. Receive this mail, and your mail server config exactitude! You can carry on other mails to send out of operate!';
...
$_LANG['js_languages']['test_email_empty'] = 'You didn\'t fill in an address of send out the test.html mail!';
$_LANG['js_languages']['email_address_same'] = 'The mail reply address must be different with sending out an address of test.html the mail!';
